...
HD_PWD='C:/Users/au087680/Downloads/LineFollowerSimple_mod.xpr/LineFollowerSimple/LineFollowerSimple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source robot_design_wrapper.tcl -notrace
