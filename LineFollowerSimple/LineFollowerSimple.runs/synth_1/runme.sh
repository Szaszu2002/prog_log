...
HD_PWD='C:/Users/au087680/Downloads/LineFollowerSimple_mod.xpr/LineFollowerSimple/LineFollowerSimple.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source robot_design_wrapper.tcl
