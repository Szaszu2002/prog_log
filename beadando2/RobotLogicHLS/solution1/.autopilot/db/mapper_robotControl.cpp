...
using hls::sim::Byte;
extern "C" void robotControl(volatile void *, volatile void *, char);
extern "C" void apatb_robotControl_hw(volatile void * __xlx_apatb_param_dutyLeft, volatile void * __xlx_apatb_param_dutyRight, char __xlx_apatb_param_sensors) {
using hls::sim::createStream;
  // DUT call
  robotControl(__xlx_apatb_param_dutyLeft, __xlx_apatb_param_dutyRight, __xlx_apatb_param_sensors);
}
