...
#set_property PACKAGE_PIN T13 [get_ports SW7]
...
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports an]
...
set_property PACKAGE_PIN L18 [get_ports {sa[6]}]
set_property PACKAGE_PIN T11 [get_ports {sa[5]}]
set_property PACKAGE_PIN P15 [get_ports {sa[4]}]
set_property PACKAGE_PIN K13 [get_ports {sa[3]}]
set_property PACKAGE_PIN K16 [get_ports {sa[2]}]
set_property PACKAGE_PIN R10 [get_ports {sa[1]}]
set_property PACKAGE_PIN T10 [get_ports {sa[0]}]
